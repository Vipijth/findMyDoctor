...
<a href=admn.php class=nl>HOME</a>

<a href=adm.php#ap class=nl>HOSPITAL LIST</a>
<a href="nsm.php " class=nl>ACCOUNTS</a>
...
<center>
<font color="black" size="5" face="kalinga" ><b><big><?php echo 'ACCOUNT LISTS'?></b>
...
if($link === false){
 ...
 echo " <table bgcolor='white' align=center' style='width:80%;'>
<tr>
<td>
<center>
<input type='text' readonly style='border-radius:0px;background:green;box-shadow:2px 2px 2px 2px black; color:white; width:205;text-align:center;' value=' Name'>
<input type='text' readonly style='border-radius:0px;background:green;box-shadow:2px 2px 2px 2px black; color:white; width:205;text-align:center;' value='Last name'>
<input type='text' readonly style='border-radius:0px;background:green;box-shadow:2px 2px 2px 2px black; color:white; width:205;text-align:center;' value='email'>
</tr>
</td>
</table>
...
<tr>
<td>";
$sqll="SELECT * FROM person_info where user like 'patient' ";
...
<input type='text' readonly style='border-radius:0px;background:white; color:black; width:205;text-align:center;' value='{$row['name']}'>
<input type='text' readonly style='border-radius:0px;background:white; color:black; width:205;text-align:center;' value='{$row['l_name']}'>
<input type='text' readonly style='border-radius:0px;background:white; color:black; width:205;text-align:center;' value='{$row['email']}'>
