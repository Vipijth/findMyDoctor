...
.x{height:260; width:28; left:100;  font-weight:bold;border-radius:4px; font-size:20px;align:right;background:white; color:white; font-family:kalinga; border:2px solid white;}
...
<a href=fmd.php class=nl style="color:gold;">HOME</a>
...
<table  align="center" bgcolor="black"   height="560" style="width:100%;top:0; ">
<tr>
<td>
<embed src="img/1.mp4" height="500" style="width:100%;top:0; ">
</td>
</tr>
</table></div></div></b></a></div></nav></div></body></html>