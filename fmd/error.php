...
<tr>
<td>
<font face="kalinga" size="5" color="#fff"style="text-shadow:2px 2px 2px #0f5989;"><b><small><center>
 <?php echo "Sorry,". $names." <FONT color=white style='text-shadow:2px 2px 2px #000;'></small> ";?> you have rached your maximum appoinments..<a href="home.php">click here to go  home<a>