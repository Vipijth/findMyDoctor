...
.sub2{padding:25px 32px; background:#000; font-family:kalinga; font-weight:bold; font-size:15;color:gold;text-decoration:none; width:230; border:1px solid white;}
.sub2:hover{ background:#fff; color:#218;text-decoration:none;}
</style>
...
<table bgcolor="white" height=540  align="left" style="border-right:1px solid grey; width:17%;position:fixed;top:120; left:0;opacity:0.8;">
<tr>
<td>
<form action="ht.php"> 
...
<form action="htp.php"> 
<input type="submit" style="background:gold; color:#218;" value=" Health Tips on Pregnancy" class=sub >
...
<b> Health Tips for the Pregnant woman<hr/ color="grey" align="left" >
<table bgcolor="black" align="center"    height="40" style=" width:100%;top:0; left:0;overflow:hidden; z-index:600; ">
<tr>
<td>
<a href="htp.php" class="sub2" style="background:#fff; color:#218;"> MONTH 1,2,3</a>
<a href="p2.php" class="sub2"> MONTH 4</a>
<a href="p3.php" class="sub2">MONTH 5</a>
<a href="p3.php" class="sub2"> MONTH 6</a>
<a href="p4.php" class="sub2"> MONTH 7</a>
<a href="p5.php" class="sub2"> MONTH 8</a>
<a href="p6.php" class="sub2"> MONTH 9</a>
</table>
<br>
<img src="img/p1.jpg"  height="460" style=" width:100%;top:0; left:0;border-radius:10px; ">
<img src="img/p2.jpg"  height="460" style=" width:100%;top:0; left:0;border-radius:10px; ">
<img src="img/p3.jpg"  height="460" style=" width:100%;top:0; left:0;border-radius:10px; ">