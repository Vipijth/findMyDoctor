...
<input type="text" readonly  style="border-radius:3px;text-align:center;font-family:kalinga;font-weight:bold; color:white;width:200;background:black; padding:3px 2px; box-shadow:2px 1px 2px 2px black;" name="user" value="admin">
<br><br>
