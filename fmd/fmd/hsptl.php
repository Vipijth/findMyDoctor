...
<?php 
 if(isset($_POST['ah']))
 {
  ...
  <tr>
  <td><center><input action='action' class='lk' onclick='window.history.go(-1); return false;'  style='width:82%;top:50;left:233;position:fixed;' type='button' value='Go Back' /><center>
...
<br><br>
 ...
 <input type='submit' name='hsm' value=submit' style='width:130px; border-radius:5px;' class='lk'>
  ...
  <input action='action' class='lk' onclick='window.history.go(-1); return false;'  style='width:82%;top:480;left:233;position:fixed;' type='button' value='Go Back' />
"; 
 }
 if(isset($_POST['hsm']))
 {
...
<input type='text' name='dname' style='width:400;' required placeholder='Enter the Doctor name'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='text' required name='spec'style='width:400;' placeholder='specialised in'>&nbsp;&nbsp;&nbsp;&nbsp;<input type='submit' name='drs' value='submit' class='lk' style='width:150;border-radius:5px;'></form>
