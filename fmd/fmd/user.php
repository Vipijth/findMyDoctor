...
<td>";
  ...
  echo '$n';
$sqt="delete from person_info where  id like '$n' ";
...
$sql="SELECT * FROM person_info where user like 'patient'";
echo "<br><br>";
echo "<table  align='right'   style='width:84%;top:0; ''>
<tr>
<td><font color='white' face='kalinga'><big><big>&nbsp;Users <hr/ style='color:white;'>
<table   align=left' style='width:100%;'>
<tr>
<td>
<center>
<input type='text' readonly style='border-radius:0px;background:green;box-shadow:2px 2px 2px 2px black; color:white; width:165;text-align:center;' value='First Name'>

<input type='text' readonly style='border-radius:0px;background:green;box-shadow:2px 2px 2px 2px black; color:white; width:165;text-align:center;' value='Last Name'>
...
<input type='text' readonly style='border-radius:0px;background:#526;box-shadow:2px 2px 2px 2px black; color:white; width:165;text-align:center;' value='{$row['l_name']}'>
