...
<form action='user.php' method='post'>
  ...
  <input type="submit" class="lk" name="uq" value="USER QUESTIONS " style="width:17%;color: white;font-weight: bold;font-family: kalinga; height:10%;left:0;top:400;border-right: 2px solid black; position:fixed; opacity: 0.9; ">
        ...
        <?php 
          if(isset($_POST['aa']))
          { 
 $v = mysqli_real_escape_string($link, $_REQUEST['veh_num']);
    $l = mysqli_real_escape_string($link, $_REQUEST['loc']);
      $c = mysqli_real_escape_string($link, $_REQUEST['contact']);
                $sqy="insert into ambulance(place,veh_num,mob_no)values('$l','$v','$c')";
...
<td>";
  ...
  echo '$n';
$sqt="delete from ambulance where  id like '$n' ";
...
<tr>
<td><font color='white' face='kalinga'><big><big>&nbsp;Ambulance Service <hr/ style='color:white;'>
<table   align=left' style='width:100%;'>
<tr>
<td>
<center><form action='' method='post'>
          <input type='text' name='veh_num' required placeholder='vehicle number(kl-01-A-1222)' style='width:300;border:1px solid #499;font-family:kalinga'>
 <input type='text' name='loc' required placeholder='enter the locality' style='width:300;border:1px solid #499;font-family:kalinga'>
 <input type='number' name='contact' id='mob' onClick='check()' required placeholder='enter a contact number 
 ' style='width:300;border:1px solid #499;font-family:kalinga'><br><br>
 <input type='submit' value='add ambulance' name='aa' class='lk' style='width:200'></form><hr/>
<input type='text' readonly style='border-radius:0px;background:green;box-shadow:2px 2px 2px 2px black; color:white; width:165;text-align:center;' value='Vehicle Number'>
...
<input type='text' readonly style='border-radius:0px;background:#526;box-shadow:2px 2px 2px 2px black; color:white; width:165;text-align:center;' value='{$row['veh_num']}'>
...
<input type='text' readonly style='border-radius:0px;background:#526;box-shadow:2px 2px 2px 2px black; color:white; width:165;text-align:center;' value='{$row['mob_no']}'>
