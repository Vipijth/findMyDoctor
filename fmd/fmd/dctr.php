...
<td>";
  ...
  echo '$n';
$sqt="delete from doctors where  id like '$n' ";
if(mysqli_query($link, $sqt)){

header('location:dctr.php');
...
<tr>
<td><font color='white' face='kalinga'><big><big>&nbsp;Doctors <hr/ style='color:white;'>
...
<input type='text' readonly style='border-radius:0px;background:green;box-shadow:2px 2px 2px 2px black; color:white; width:165;text-align:center;' value='Working Hospital'>
...
<input type='text' readonly style='border-radius:0px;background:#526;box-shadow:2px 2px 2px 2px black; color:white; width:165;text-align:center;' value='{$row['spec']}'>
<input type='text' readonly style='border-radius:0px;background:#526;box-shadow:2px 2px 2px 2px black; color:white; width:165;text-align:center;' value='{$row['hospital']}'>
