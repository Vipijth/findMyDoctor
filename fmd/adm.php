...
<a href=#ap class=nl>HOSPITAL LIST</a>
...
<center>
<font color="black" size="5" face="kalinga" ><b><big><?php echo 'HOSPITAL LISTS'?></b>
...
<td>
<center>
<input type='text' readonly style='border-radius:0px;background:green;box-shadow:2px 2px 2px 2px black; color:white; width:205;text-align:center;' value='HOSPITAL Name'>
<input type='text' readonly style='border-radius:0px;background:green;box-shadow:2px 2px 2px 2px black; color:white; width:205;text-align:center;' value='Place'>
<input type='text' readonly style='border-radius:0px;background:green;box-shadow:2px 2px 2px 2px black; color:white; width:205;text-align:center;' value='USER NAME'>
</tr>
</td>
</table>
...
<input type='text' readonly style='border-radius:0px;background:white; color:black; width:205;text-align:center;' value='{$row['place']}'>
<input type='text' readonly style='border-radius:0px;background:white; color:black; width:205;text-align:center;' value='{$row['username']}'>
