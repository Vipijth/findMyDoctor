...
// Escape user inputs for security0
...
.zz{width:280; color:white; background:#000;}
...
<input action="action" onclick="window.history.go(-1); return false;" style="width:100px" type="button" value="Back" />
<table  align="center" bgcolor="white" width="960" height="360" style="width100%;top:15;border-radius:10px; ">
<tr>
<td><center><font color="black" size="5" face="kalinga"><b><big><?php echo $hs; ?></font></big></b>
<br>
<font color="black" size="4" face="kalinga">SPECIALISED In &nbsp;&nbsp;<b><?php echo $spec; ?></font></big></b>
<br></center><b><?php  echo "<input type='hidden'  name='dn' readonly style='border-radius:0px;width:40;text-align:center;' value='$hs'>
<input type='hidden'  name='sp' readonly style='border-radius:0px;width:40;text-align:center;' value='$spec'>
"?>
CONSULTING TIMES<hr/>
...
if($link === false){
 ...
 echo " <table bgcolor='green' align=center' style='width:96%;'>
<tr>
<td>
<center> 
<input type='text' readonly style='border-radius:0px;background:green;box-shadow:2px 2px 2px 2px black; color:white; width:240;text-align:center;' value='AVAILABLE DATES'>
<input type='text' readonly style='border-radius:0px;background:green;box-shadow:2px 2px 2px 2px black; color:white; width:240;text-align:center;' value='CONSULTING TIME'>
<input type='text' readonly style='border-radius:0px;background:green;box-shadow:2px 2px 2px 2px black; color:white; width:280;text-align:center;' value='AVAILABLE TOCKENS'>

</tr>
</td>
</table>
 <table bgcolor='green' align=center' style='width:96%;'>
<tr>
<td>";
	$io=1;
...
$sqll="SELECT * FROM times  where name like '$hs' and spec like '%$spec%' and id='$io'";
...
$exp=$row['starttime'];
 ...
 echo "<form action='tk.php'  method='post'>
<b><center>
<input type='hidden'  name='dn' readonly style='border-radius:0px;width:40;text-align:center;' value='$hs'>
<input type='hidden'  name='sp' readonly style='border-radius:0px;width:40;text-align:center;' value='$spec'>
...
$time'>
<input type='hidden' name='exptime' readonly style='border-radius:0px; width:240;text-align:center;' value='
{$row['starttime']}'>

<input type='submit' value='AVAILABLE TOCKENS' class='zz' >
</form>";
  }
  }
?></table>
